...
const DEFAULT_QR = '{DEFAULT_QR}';
const DEFAULT_BARCODE = '{DEFAULT_BARCODE}';
...
export default function SngplOfficialBillDocument({{ bill, onPrint }}: SngplOfficialBillDocumentProps) {{
  ...
  return (
    <div className="sngpl-official-bill-container">
      <div className="sngpl-bill-action-bar sngpl-bill-no-print">
      ...
      <div id="sngpl-printable-bill" className="A4" style={{{{ fontFamily: 'sans-serif' }}}}>
        <div className="sheet" style={{{{ position: 'relative' }}}}>
          {{/* eslint-disable-next-line @next/next/no-img-element */}}
          <img src="/sngpl-bill-template.jpg" alt="SNGPL Bill Template" style={{{{ width: '210mm', height: '292mm', padding: '0px' }}}} />
          <div style={{{{ position: 'absolute', top: '0px', left: '15px', width: '98%' }}}}>
              ...
              <tbody>
                ...
                <tr>
                  <td height="40px" colSpan={{{{2}}}} width="100%">
                    {{/* eslint-disable-next-line @next/next/no-img-element */}}
                    <img src={{{{barcode}}}} alt="Bar code" height="35px" width="340px" border={{{{0}}}} style={{{{ paddingRight: '20px', paddingTop: '0px', float: 'right' }}}} />
                  </td>
                </tr>
...
print(f"SUCCESS: Written {size} bytes to {filepath}")
